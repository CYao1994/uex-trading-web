...
import { Home, SwapHoriz, ShoppingCart, Link, Build, GpsFixed, MilitaryTech, MoreHoriz, PrecisionManufacturing, Rocket, Science } from '@mui/icons-material';
...
const MORE_TABS = [
  ...
  { key: 'ships', label: '舰船数据库', icon: <Rocket sx={{ fontSize: 18 }} /> },
