...
import { Box, Typography, Button, Divider, Alert, Autocomplete, TextField, InputAdornment } from '@mui/material';
import { Link, RocketLaunch, Refresh, DirectionsCar } from '@mui/icons-material';
    ...
    <Box sx={{
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2.5 }}>
        <Box sx={{
          ...
          <Link sx={{ color: '#00c8ff', fontSize: 18 }} />
        </Box>
        <Box>
      ...
      {/* Vehicle Selection */}
      <Box sx={{ mb: 2.5 }}>
        <Typography variant="subtitle2" sx={{ color: 'rgba(0, 200, 255, 0.5)', mb: 1, fontWeight: 600, fontSize: '0.75rem', letterSpacing: '0.1em', fontFamily: '"Orbitron", sans-serif' }}>
          飞船选择
        </Typography>
        <Autocomplete
          size="small"
          ...
          renderInput={(params) => (
            <TextField
              ...
              sx={{
                ...
                '& .MuiInputAdornment-root': { color: 'rgba(0, 200, 255, 0.3)' },
              }}
              InputProps={{
                ...params.InputProps,
                startAdornment: (
          ...
          sx={{
            '& .MuiAutocomplete-popupIndicator': { color: 'rgba(0, 200, 255, 0.3)' },
            '& .MuiAutocomplete-clearIndicator': { color: 'rgba(0, 200, 255, 0.3)' },
            ...
            '& .MuiAutocomplete-option': {
              color: '#00d4ff',
              fontSize: '0.8rem',
              '&:hover': { background: 'rgba(0, 200, 255, 0.08)' },
              '&.Mui-focused': { background: 'rgba(0, 200, 255, 0.12)' },
            },
          }}
        />
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 1 }}>
          <Box
            ...
            sx={{
              width: 16, height: 16,
              border: `1px solid ${useCustomScu ? '#00c8ff' : 'rgba(0, 180, 255, 0.2)'}`,
              borderRadius: '2px',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              cursor: 'pointer',
              background: useCustomScu ? 'rgba(0, 200, 255, 0.15)' : 'transparent',
              transition: 'all 0.2s',
            }}
          >
            {useCustomScu && (
              <Box sx={{ width: 8, height: 8, background: '#00c8ff', borderRadius: '1px' }} />
            )}
          </Box>
          <Typography
            onClick={() => setUseCustomScu(!useCustomScu)}
            sx={{
              color: useCustomScu ? '#00c8ff' : 'rgba(0, 200, 255, 0.4)',
              fontSize: '0.75rem',
              cursor: 'pointer',
              fontFamily: '"Rajdhani", "Noto Sans SC", sans-serif',
            }}
          ...
          {vehicle && !useCustomScu && (
            <Typography sx={{ color: 'rgba(0, 200, 255, 0.4)', fontSize: '0.7rem', ml: 'auto' }}>
              {vehicle.scu} SCU
            </Typography>
          )}
        </Box>
      ...
      <Box sx={{ mb: 2.5 }}>
        ...
        <TextField
          ...
          InputProps={{
            endAdornment: <InputAdornment position="end" sx={{ color: 'rgba(0, 200, 255, 0.3)', fontSize: '0.75rem' }}>aUEC</InputAdornment>,
          }}
          sx={{
            '& .MuiOutlinedInput-root': {
              color: '#00d4ff',
