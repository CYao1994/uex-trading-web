      ...
      <DialogTitle sx={{
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          ...
          <Box sx={{ display: 'flex', gap: 1, mt: 0.5, flexWrap: 'wrap' }}>
            <Typography sx={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.5)', fontFamily: '"Noto Sans SC","Rajdhani",sans-serif' }}>
      ...
      <DialogContent sx={{ pt: 2 }}>
        ...
        <Box sx={{ mb: 1 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 1 }}>
            ...
            <Typography sx={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.35)', fontFamily: '"Rajdhani",sans-serif' }}>
